                    ...
                    <tr>
                        <td
                            ...
                            <div style="padding: 28px 32px;">
                                ...
                                <p style="margin: 0 0 16px 0; font-size: 14px; line-height: 1.6; color: #52525b;">Our
                                    support team has replied to your ticket. You can view the full conversation and
                                    reply below.</p>
                                ...
                                @if (isset($reply) && strlen(strip_tags($reply->message)) > 0)
                                    <div
                                        style="background: #fafafa; border-radius: 8px; padding: 16px; margin: 20px 0;">
                                        <p
                                            style="margin: 0 0 8px 0; font-size: 11px; color: #a1a1aa; text-transform: uppercase; font-weight: 600; letter-spacing: 0.05em;">
                                            Latest reply</p>
                                        <p style="margin: 0; font-size: 14px; line-height: 1.6; color: #52525b;">
                                            {{ Str::limit(strip_tags($reply->message), 200) }}</p>
                                    </div>
                                @endif
                                ...
                                <p style="margin: 20px 0 0 0; font-size: 12px; color: #a1a1aa; text-align: center;">Use
                                    the link above to view the full conversation and send a reply.</p>
                            </div>
                        </td>
                    </tr>
