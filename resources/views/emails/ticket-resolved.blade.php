...
<body>
    <div class="header">
        ...
        <h1 style="margin: 0; font-size: 24px;">Your Ticket Has Been Resolved</h1>
    </div>

    <div class="content">
        <p>Hello <strong>{{ $ticket->customer_name }}</strong>,</p>

        <p>We're pleased to let you know that your support ticket has been marked as resolved.</p>
        ...
        <div class="notice">
            If you feel your issue hasn't been fully resolved, you can reopen this ticket by replying below.
        </div>
        ...
        <p style="margin-top: 20px; font-size: 14px; color: #6b7280;">If you're satisfied with the resolution, no
            action is needed. The ticket will be automatically closed after a period of inactivity.</p>
    </div>
