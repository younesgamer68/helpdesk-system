    ...
    <div class="min-h-screen bg-[#0A170F] flex items-center justify-center px-4">
        ...
        <div class="w-full max-w-md text-center">
            ...
            <div class="flex items-center my-8">
                ...
                <span class="mx-4 text-white text-lg font-light">or</span>
                <div class="flex-grow border-t border-white"></div>
            </div>

            <!-- Email Form -->
            <form method="POST" action="{{ route('register.quick') }}" id="signup-form" class="space-y-6">
                @csrf
            ...
            <p class="text-white/60 text-sm mt-6">
                ...
                <a href="{{ route('login') }}" class="text-teal-400 hover:text-teal-300 font-semibold">Log in</a>
            </p>
        </div>
