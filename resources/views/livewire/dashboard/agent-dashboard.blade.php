<div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-2">
        <button type="button" x-on:click="$flux.modal('open-tickets-modal').show()" class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 text-left transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800/80">
            <div class="flex items-center justify-between mb-3">
                ...
                <div class="p-1.5 bg-blue-500/10 rounded-lg">
                    <svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                </div>
            </div>
        ...
        <button type="button" x-on:click="$flux.modal('pending-tickets-modal').show()" class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 text-left transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800/80">
            ...
            <p class="text-3xl font-bold text-white">{{ $this->pendingReplyCount }}</p>
        </button>

        <a href="{{ route('notifications', Auth::user()->company->slug) }}" wire:navigate class="bg-zinc-900 border border-zinc-800 rounded-xl p-5 text-left transition-colors hover:bg-zinc-800/50">
            <div class="flex items-center justify-between mb-3">
                <span class="text-xs font-medium text-zinc-400 uppercase tracking-wider">Unread Notifications</span>
            ...
            <p class="text-3xl font-bold text-white">{{ $this->unreadNotificationsCount }}</p>
        </a>
    </div>
        ...
        <div class="lg:col-span-3 space-y-6">
            ...
            <div class="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
                <div class="flex items-center justify-between px-5 py-4 border-b border-zinc-800">
                    <h2 class="text-base font-semibold text-white">My Tickets</h2>
                ...
                @else
                    <div class="px-5 py-12 text-center">
                        <p class="text-sm text-zinc-500">You have no open tickets 🎉</p>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden">
                <div class="px-5 py-4 border-b border-zinc-800">
                    <h2 class="text-base font-semibold text-white">Unassigned Tickets</h2>
                ...
                @else
                    <div class="px-5 py-10 text-center">
                        <p class="text-sm text-zinc-500">No unassigned tickets right now</p>
                    </div>
                @endif
            </div>
