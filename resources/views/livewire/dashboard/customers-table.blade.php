        ...
        <table class="w-full">
            ...
            <tbody class="divide-y divide-zinc-800">
                @forelse ($this->customers as $customer)
                    <tr class="hover:bg-zinc-900/30 transition-colors" wire:key="{{ $customer->id }}">
                        ...
                        <td class="px-4 py-3 text-sm text-zinc-300">
                            <span class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-zinc-800 text-xs font-medium">
                        ...
                        <td class="px-4 py-3 text-sm text-right">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('customers.details', ['company' => Auth::user()->company->slug, 'customer' => $customer->id]) }}" 
                                    wire:navigate
                                    class="p-1.5 text-zinc-400 hover:text-teal-400 hover:bg-teal-400/10 rounded-lg transition-colors" title="View Details">
                                ...
                                <button wire:click="toggleStatus({{ $customer->id }})" 
                                    ...
                                    class="p-1.5 {{ $customer->is_active ? 'text-zinc-400 hover:text-red-400 hover:bg-red-400/10' : 'text-zinc-400 hover:text-green-400 hover:bg-green-400/10' }} rounded-lg transition-colors" 
                ...
                @empty
                    <tr>
                        <td colspan="6" class="px-4 py-12 text-center">
                            ...
                            <p class="mt-4 text-zinc-400">No customers found. Try adjusting your filters.</p>
                        </td>
                    </tr>
                @endforelse
            </tbody>
