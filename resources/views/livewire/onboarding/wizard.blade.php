                    ...
                    <div class="space-y-6">
                        ...
                        <div class="pt-6 mt-6 border-t border-zinc-200 dark:border-zinc-800 space-y-4">
                            ...
                            <div x-show="$wire.slaIsEnabled" class="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2">
                                ...
                                <flux:input type="number" wire:model="slaMediumMinutes"
                                    label="Medium Priority (minutes)" min="1" description="Default: 480 (8h)" />
                                <flux:input type="number" wire:model="slaHighMinutes" label="High Priority (minutes)"
                                    min="1" description="Default: 120 (2h)" />
                                <flux:input type="number" wire:model="slaUrgentMinutes"
                                    label="Urgent Priority (minutes)" min="1" description="Default: 30 (30m)" />
                            </div>
                        </div>
                            ...
                            @foreach ($invites as $index => $invite)
                                <div
                                    ...
                                    <flux:button wire:click="removeInvite({{ $index }})" variant="subtle"
                                        icon="trash" class="text-zinc-400 hover:text-red-500 mb-1 w-full md:w-auto" />
                                </div>
                            @endforeach
                        </div>
                                        ...
                                        <div class="space-y-3">
                                            @if ($widgetShowCategory)
                                                <div
                                                    ...
                                                    <span class="text-xs text-zinc-400">Select Category...</span></div>
                                            @endif
                                            ...
                                            @if ($widgetRequirePhone)
                                                <div
                                                    class="h-10 bg-zinc-100 dark:bg-zinc-800 rounded-lg w-full flex items-center px-3">
                                                    <span class="text-xs text-zinc-400">Phone Number *</span></div>
                                            @endif
