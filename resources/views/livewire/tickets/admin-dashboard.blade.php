<div>
    ...
    <div class="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
        ...
        <!-- SLA Breaches -->
        <div
            class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-xl p-5 relative overflow-hidden group">
            <div class="flex items-center justify-between mb-3">
            ...
            <p
                class="text-3xl font-bold {{ $this->slaBreachCount > 0 ? 'text-red-500' : 'text-zinc-600 dark:text-zinc-100' }}">
                {{ $this->slaBreachCount }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div class="lg:col-span-2 flex flex-col space-y-4">
            ...
            <div
                class="bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden flex-1">
                ...
                @else
                    <div class="overflow-x-auto">
                        <table class="w-full text-left text-sm whitespace-nowrap">
                            <thead
                                class="bg-zinc-50 dark:bg-zinc-900/50 text-zinc-500 dark:text-zinc-400 text-xs uppercase font-medium border-b border-zinc-200 dark:border-zinc-800/80">
                                <tr>
                                ...
                                @foreach ($this->recentTickets as $ticket)
                                    <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/30 transition-colors group cursor-pointer"
                                        ...
                                        <td class="px-6 py-3.5">
                                            @if ($ticket->assignedTo)
                                                <div class="flex items-center gap-2">
                                                    <div
                                                        class="w-6 h-6 rounded-full bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center text-[10px] font-medium text-zinc-600 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700">
                                        ...
                                        <td class="px-6 py-3.5">
                                            ...
                                            @endphp
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border {{ $priorityBg }}">
                                        ...
                                        <td class="px-6 py-3.5">
                                            ...
                                            @endphp
                                            <span
                                                class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium border {{ $statusBg }}">
                            ...
                            <div class="px-5 py-4 flex items-center justify-between">
                                ...
                                <div class="ml-4 flex-shrink-0 w-32">
                                    @php
                                        ...
                                        $labelColor =
                                            $percentage > 90 ? 'text-red-500' : 'text-zinc-500 dark:text-zinc-400';
                                    @endphp

                                    <div
                                        class="w-full bg-zinc-200 dark:bg-zinc-800 rounded-full h-1.5 mb-2 overflow-hidden">
    ...
    <div class="space-y-4">
        ...
        <div
            class="bg-zinc-50 dark:bg-zinc-900/50  border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden p-1">
                                    ...
                                    @if ($log->user)
                                        <span class="font-medium text-zinc-900 dark:text-zinc-100">
                                            @if ($log->user->id === Auth::id())
                                                You <span
                                                    class="text-xs text-zinc-400 font-normal">({{ $log->user->name }})</span>
                                            @else
                                                {{ $log->user->name }}
                                            @endif
                                        </span>
