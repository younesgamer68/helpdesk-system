    ...
    <div class="min-h-screen flex items-center justify-center p-4 sm:p-6 lg:p-8">
        <div class="w-full max-w-xl">
            ...
            <div id="success-message" class="hidden">
                <div
                    class="bg-white dark:bg-zinc-900 border border-emerald-200 dark:border-emerald-800/40 rounded-xl p-8 shadow-lg dark:shadow-zinc-950/50 text-center">
                    <div
                        class="mx-auto w-16 h-16 bg-emerald-100 dark:bg-emerald-900/30 rounded-full flex items-center justify-center mb-5">
            ...
            <div id="widget-form">
                <div
                    class="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-lg dark:shadow-zinc-950/50 overflow-hidden">

                    {{-- Header --}}
                    <div class="px-8 pt-8 pb-6">
                        <div class="flex items-center gap-3">
                            @if ($widget->company->logo)
                                <img src="{{ Storage::url($widget->company->logo) }}" alt="{{ $widget->company->name }}"
                                    class="h-9 w-9 rounded-lg object-contain shrink-0">
                            @endif
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
                                    {{ $widget->form_title }}</h1>
                                @if ($widget->welcome_message)
                                    <p class="mt-1 text-sm text-gray-500 dark:text-zinc-400 leading-relaxed">
                    ...
                    <div id="error-alert" class="hidden mx-8 mt-6">
                        <div
                            class="flex items-start gap-3 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800/40 rounded-lg p-4">
                    ...
                    <form id="ticket-form" class="p-8 space-y-5">
                        ...
                        @if ($widget->show_category && $widget->company->categories->count() > 0)
                            <div class="space-y-1.5">
                                <label class="block text-sm font-medium text-gray-700 dark:text-zinc-300">
                                    Category <span
                                        class="text-gray-400 dark:text-zinc-500 text-xs font-normal">(Optional)</span>
                                </label>
