...
<body class="font-sans antialiased text-gray-900 h-full overflow-hidden" x-data="{ show: false }" x-init="setTimeout(() => show = true, 50)">
    <div class="h-full w-full overflow-y-auto bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-md mb-6">
            <div class="flex justify-center items-center gap-3">
                <img src="{{ asset('images/logolm.png') }}" class="h-12 w-auto" alt="HelpDesk Logo">
                <span class="text-2xl font-bold tracking-tight text-gray-900">HelpDesk</span>
            </div>
        </div>
