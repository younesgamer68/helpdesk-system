    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-10">
        ...
        <div class="lg:col-span-1 space-y-8">
            @if ($category->children->count() > 0)
                <div>
                    <h3 class="text-sm font-bold uppercase tracking-wider text-zinc-500 dark:text-zinc-400 mb-4 px-2">
                        Subcategories</h3>
                    <ul class="space-y-2">
            ...
            <div
                ...
                <p class="text-sm text-zinc-600 dark:text-zinc-400 mb-6 leading-relaxed">Can't find the answers you're
                    looking for? Our support team is here to help.</p>
                <a href="{{ $company->website ?? '#' }}"
                    class="inline-flex w-full justify-center items-center gap-2 py-3 px-4 bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 rounded-xl text-sm font-semibold hover:bg-zinc-800 dark:hover:bg-zinc-100 transition shadow">
                    Contact Support
        ...
        <div class="lg:col-span-3">
            ...
            @else
                <div
                    class="text-center py-20 px-6 border-2 border-dashed border-zinc-200 dark:border-zinc-800 rounded-3xl bg-zinc-50 dark:bg-zinc-900/50">
                    <div
                        class="w-16 h-16 bg-zinc-100 dark:bg-zinc-800 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    ...
                    <p class="mt-2 text-zinc-500 max-w-sm mx-auto">It looks like we haven't published any articles in this
                        category yet. Check back soon!</p>
                </div>
            @endif
