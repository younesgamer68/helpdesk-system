        ...
        <div x-show="showSummary" class="p-4 bg-zinc-50 dark:bg-zinc-800/50 transition-all duration-300"
            ...
            <div x-show="isLoading && !displayedSummary" class="space-y-4" style="display: none;">
                ...
                <div class="flex items-center gap-2 text-teal-400 mt-2">
                    <span class="animate-pulse inline-block w-[8px] h-[1em] align-middle bg-teal-400"></span>
                    <span class="text-xs">Generating summary...</span>
                </div>
            </div>

            <div x-show="displayedSummary || (!isLoading && !displayedSummary)" class="border-l-2 border-teal-500 pl-4">
                <div class="space-y-4 px-2 text-sm">
                    <div>
                        <span class="font-semibold text-teal-400 text-xs uppercase tracking-wide">Issue</span>
                    ...
                    <div>
                        <span class="font-semibold text-teal-400 text-xs uppercase tracking-wide">Progress</span>
                        <p class="text-zinc-600 dark:text-zinc-300 mt-1 leading-relaxed whitespace-pre-wrap"
                    ...
                    <div>
                        <span class="font-semibold text-teal-400 text-xs uppercase tracking-wide">Next Step</span>
                        <p class="text-zinc-600 dark:text-zinc-300 mt-1 leading-relaxed whitespace-pre-wrap"
                ...
                <div x-show="!displayedSummary && !isLoading" class="text-sm px-1 text-zinc-500 dark:text-zinc-400"
                    style="display: none;">
                    <span class="animate-pulse inline-block mr-1 w-[8px] h-[1em] align-middle bg-teal-400"></span>
                    Waiting for summary...
                </div>
            </div>
        </div>
