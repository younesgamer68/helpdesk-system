        ...
        <div
            ...
            @forelse ($logs as $log)
                <div
                    ...
                    <div
                        class="flex items-center justify-center w-10 h-10 rounded-full bg-zinc-50 dark:bg-zinc-900 text-zinc-500 shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 sm:mx-0 mx-auto z-10">
                        @switch($log->action)
                            @case('status_changed')
