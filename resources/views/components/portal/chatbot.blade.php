        ...
        <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
            ...
            <div x-show="!chatting" class="flex h-full flex-col">
                ...
                <div class="shrink-0 bg-linear-to-br from-[#0a0a0a] via-[#17494D] to-brand px-4 pb-4 pt-4">
                    <div class="flex items-center gap-2.5">
                        <div class="flex h-9 w-9 items-center justify-center rounded-xl bg-linear-to-br from-[#1b7a44] to-brand shadow-[0_4px_10px_rgba(33,150,83,0.3)]">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-1.5">
                                <span class="h-[5px] w-[5px] rounded-full bg-[#219653] shadow-[0_0_6px_#219653] animate-[chatbot-pulse_2s_infinite]"></span>
                ...
                <div class="flex-1 overflow-y-auto [&::-webkit-scrollbar]:w-[3px] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-brand/30">
                    ...
                    <template x-if="conversations.length === 0">
                        <div class="flex h-full flex-col items-center justify-center px-8 py-12">
                            <div class="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-[rgba(33,150,83,0.1)] to-[rgba(33,150,83,0.03)]">
            ...
            <div x-show="chatting" class="flex h-full flex-col">
                ...
                <div class="flex shrink-0 items-center gap-2.5 bg-linear-to-br from-[#0a0a0a] via-[#17494D] to-brand px-4 py-2.5">
                    ...
                    <div class="flex h-7 w-7 items-center justify-center rounded-lg bg-linear-to-br from-[#1b7a44] to-brand shadow-[0_3px_8px_rgba(33,150,83,0.25)]">
                            ...
                            <div>
                                ...
                                <template x-if="msg.type === 'bot'">
                                    <div class="flex items-end gap-1.5">
                                        <div class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-[#1b7a44] to-brand">
                                ...
                                <template x-if="msg.type === 'user'">
                                    <div class="flex justify-end">
                                        <div class="flex max-w-[78%] flex-col items-end gap-0.5">
                                            <div class="rounded-xl rounded-br-md bg-linear-to-br from-[#1b7a44] to-brand px-3 py-2 shadow-[0_3px_10px_rgba(33,150,83,0.2)]">
                        ...
                        <div class="flex items-end gap-1.5" x-show="sending">
                            ...
                            <div class="rounded-xl rounded-bl-md bg-white px-3 py-2.5 shadow-[0_1px_3px_rgba(0,0,0,0.03),0_0_0_1px_rgba(0,0,0,0.02)]">
                                <div class="flex gap-1">
                                    <span class="h-[5px] w-[5px] rounded-full bg-[#1b7a44] opacity-80 animate-[chatbot-bounce_1.2s_infinite]"></span>
                                    <span class="h-[5px] w-[5px] rounded-full bg-[#1b7a44] opacity-80 animate-[chatbot-bounce_1.2s_infinite_150ms]"></span>
                                    <span class="h-[5px] w-[5px] rounded-full bg-[#1b7a44] opacity-80 animate-[chatbot-bounce_1.2s_infinite_300ms]"></span>
                                </div>
                            </div>
                        </div>
                    </div>
