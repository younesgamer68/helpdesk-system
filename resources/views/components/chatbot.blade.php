    ...
    <div x-data="{
        ...
        init() {
            window.addEventListener('open-chatbot-widget', () => {
                ...
                if (!this.chatting && this.conversations.length === 0) {
        ...
        <div x-show="open" x-cloak x-transition:enter="transition ease-out duration-200"
            ...
            <div x-show="!chatting" class="flex h-full flex-col">
                ...
                <div class="shrink-0 bg-linear-to-br from-[#0a0a0a] via-[#17494D] to-brand px-4 pb-4 pt-4">
                    <div class="flex items-center gap-2.5">
                        <div
                            class="flex h-9 w-9 items-center justify-center rounded-xl bg-linear-to-br from-[#00A983] to-brand shadow-[0_4px_10px_rgba(45,175,45,0.3)]">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="flex items-center gap-1.5">
                                <span
                                    class="h-[5px] w-[5px] rounded-full bg-green-400 shadow-[0_0_6px_#4ade80] animate-[chatbot-pulse_2s_infinite]"></span>
                ...
                <div
                    ...
                    <template x-if="conversations.length === 0">
                        <div class="flex h-full flex-col items-center justify-center px-8 py-12">
                            <div
                                class="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-linear-to-br from-[rgba(45,175,45,0.1)] to-[rgba(45,175,45,0.03)]">
            ...
            <div x-show="chatting" class="flex h-full flex-col">
                ...
                <div
                    ...
                    <button @click="backToHome()" type="button"
                    ...
                    <div
                        class="flex h-7 w-7 items-center justify-center rounded-lg bg-linear-to-br from-[#00A983] to-brand shadow-[0_3px_8px_rgba(45,175,45,0.25)]">
                            ...
                            <div>
                                ...
                                <template x-if="msg.type === 'bot'">
                                    <div class="flex items-end gap-1.5">
                                        <div
                                            class="flex h-6 w-6 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-[#00A983] to-brand">
                                ...
                                <template x-if="msg.type === 'user'">
                                    <div class="flex justify-end">
                                        <div class="flex max-w-[78%] flex-col items-end gap-0.5">
                                            <div
                                                class="rounded-xl rounded-br-md bg-linear-to-br from-[#00A983] to-brand px-3 py-2 shadow-[0_3px_10px_rgba(45,175,45,0.2)]">
                        ...
                        <div class="flex items-end gap-1.5" x-show="sending">
                            ...
                            <div
                                ...
                                <div class="flex gap-1">
                                    <span
                                        class="h-[5px] w-[5px] rounded-full bg-[#2DAF2D] opacity-80 animate-[chatbot-bounce_1.2s_infinite]"></span>
                                    <span
                                        class="h-[5px] w-[5px] rounded-full bg-[#2DAF2D] opacity-80 animate-[chatbot-bounce_1.2s_infinite_150ms]"></span>
                                    <span
                                        class="h-[5px] w-[5px] rounded-full bg-[#2DAF2D] opacity-80 animate-[chatbot-bounce_1.2s_infinite_300ms]"></span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <button @click="toggle()" type="button"
            ...
            <svg x-show="open" x-cloak class="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke-width="2.5"
                stroke="currentColor">
